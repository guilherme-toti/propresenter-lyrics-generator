  ...
  return (
    <aside className="flex h-full w-72 shrink-0 flex-col border-r border-line bg-cream-100/60 p-4">
      <div className="mb-3 flex items-center justify-between">
        <p className="text-[11px] font-semibold uppercase tracking-widest text-ink/45">Projetos</p>
      </div>
      <h2 className="mb-3 font-display text-lg font-semibold text-ink">Sua biblioteca</h2>
